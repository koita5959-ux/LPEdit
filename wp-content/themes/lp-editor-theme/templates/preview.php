    ...
    <main>
        ...
        <section class="py-16 md:py-24 px-4" id="contact" style="background-color:#F3F4F6">
            <div class="max-w-md mx-auto">
                ...
                <form id="contact-form" class="space-y-4 bg-white p-6 md:p-10 rounded-2xl border border-gray-100 shadow-sm" novalidate>
                    <?php
                    $field_index = 0;
                    ...
                    <p class="text-xs text-gray-500 mb-2">※テストモード：実際の送信は行われません</p>
                ...
                <div id="success-modal" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 hidden">
                    <div class="bg-white rounded-2xl p-8 mx-4 max-w-sm w-full text-center shadow-xl">
                        ...
                        <h4 class="text-xl font-bold text-gray-900 mb-2">送信完了（テスト）</h4>
                        <p class="text-sm text-gray-600 mb-6">フォームのバリデーションが正常に通過しました。<br>※実際の送信は行われていません。</p>
                        <button id="close-modal" class="bg-primary text-white font-bold py-2 px-6 rounded-lg hover:opacity-90">
                            閉じる
                        </button>
                    </div>
                </div>
                <div class="mt-6">
                    ...
                    <div id="bottom-cta" class="fixed bottom-0 left-0 w-full z-40 pointer-events-none pt-3 px-4 transition-all duration-500 transform translate-y-full opacity-0">
                        <div class="container mx-auto max-w-md md:max-w-2xl flex gap-3 pb-4 pointer-events-auto">
                            <a class="flex-1 bg-primary font-bold py-3 rounded-lg flex flex-col items-center justify-center shadow-xl hover:opacity-80 transition-all text-center"
                                style="color:<?php echo esc_attr($text_on_primary); ?>" href="#contact">
